...
include_once(SOCKETLABS_INJECTION_API_ROOT_PATH . "/src/Core/Serialization/AttachmentJson.php");
...
include_once(SOCKETLABS_INJECTION_API_ROOT_PATH . "/src/Core/Serialization/MetadataJson.php");
...
include_once(SOCKETLABS_INJECTION_API_ROOT_PATH . "/src/Message/Metadata.php");
